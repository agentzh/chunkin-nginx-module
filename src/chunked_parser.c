...
#line 135 "src/chunked_parser.rl"
	{
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 1037 "src/chunked_parser.c"
	_widec = (*p);
	_widec = (short)(128 + ((*p) - -128));
	if ( 
#line 62 "src/chunked_parser.rl"
...
st21:
	if ( ++p == pe )
		goto _test_eof21;
case 21:
#line 1224 "src/chunked_parser.c"
	_widec = (*p);
	_widec = (short)(128 + ((*p) - -128));
	if ( 
#line 62 "src/chunked_parser.rl"
...
st22:
	if ( ++p == pe )
		goto _test_eof22;
case 22:
#line 1285 "src/chunked_parser.c"
	if ( (*p) == 10 )
		goto st23;
	goto st0;
tr41:
...
st23:
	if ( ++p == pe )
		goto _test_eof23;
case 23:
#line 1309 "src/chunked_parser.c"
	_widec = (*p);
	_widec = (short)(128 + ((*p) - -128));
	if ( 
#line 62 "src/chunked_parser.rl"
...
st25:
	if ( ++p == pe )
		goto _test_eof25;
case 25:
#line 1393 "src/chunked_parser.c"
	_widec = (*p);
	_widec = (short)(128 + ((*p) - -128));
	if ( 
#line 62 "src/chunked_parser.rl"
...
st27:
	if ( ++p == pe )
		goto _test_eof27;
case 27:
#line 1467 "src/chunked_parser.c"
	_widec = (*p);
	_widec = (short)(128 + ((*p) - -128));
	if ( 
#line 62 "src/chunked_parser.rl"
...
#line 44 "src/chunked_parser.rl"
	...
	break;
#line 1566 "src/chunked_parser.c"
	}
	}
